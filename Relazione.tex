...
alimentato con soli 3 fili, questo spiegherebbe la presenza di una corrente
omopolare al primario. Osservando la FFT della corrente al primario, si notano la 
...
Inserendo nel carico anche l'induttore si può vedere come cambia la forma d'onda
della corrente
