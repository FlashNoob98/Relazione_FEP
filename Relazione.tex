...
&= \frac{3\sqrt{2}V_{\lambda}}{\sqrt{\pi}}\cdot \sqrt{\frac{\pi}{6} + \frac{1}{4}\left[2\cdot\sin\left(\frac{\pi}{3}\right)\cos(2\alpha) + \cancel{\cos\left(\frac{\pi}{3}\right)\sin(2\alpha)} -\cancel{\sin(2\alpha)\cos\left(\frac{\pi}{3}\right)} \right]  } =\\
